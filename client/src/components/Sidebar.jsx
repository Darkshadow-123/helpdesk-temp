const navItems = [
  ...
  { id: 'views', label: 'Views', icon: 'filter' },
...
export default function Sidebar({ activeNav, onNavChange, onCreateTicket, onLogout, user }) {
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          <div className="user-avatar" style={{ background: user?.color || '#6366F1' }}>
            {user?.initials || 'U'}
          </div>
